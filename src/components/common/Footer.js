          ...
          <div className="grid grid-cols-2 gap-x-[45px]">
            <div>
              <nav className="xs:py-[25px]">
                <p className="xs:text-[20px] xs:leading-[17px] font-normal font-helvetica">
              ...
              <nav>
                ...
                <p className="link opacity-60 link-hover xs:pt-[10px] xs:pb-[8px]  xs:text-[20px] xs:leading-[12px] font-normal font-helvetica">
                  Terms Of Use
                </p>
                <p className="link link-hover opacity-60 xs:pb-[8px] xs:text-[20px] xs:leading-[12px] font-normal font-helvetica">
                  Privacy policy
                </p>
                <Link  href='/faq'>
                 <p className="link link-hover opacity-60  xs:text-[20px] xs:leading-[12px] font-normal font-helvetica">
                  FAQ
                </p>
                </Link>
            ...
            <div>
              <nav>
                <h6 className="xs:pb-[10px] pt-[25px] xs:text-[16px]  xs:leading-[24px]  font-helvetica font-bold text-white">
                 ...
                 <Link  href='/'>
                  <p className="xs:pb-[8px] opacity-60 link link-hover xs:text-[20px] xs:leading-[12px] font-normal font-helvetica">
                  Home
                </p>
                 </Link>
               ...
               <Link  href='/concept'>
                <p className="xs:pb-[35px] opacity-60 link link-hover xs:text-[20px] xs:leading-[12px] font-normal font-helvetica">
                  Concept
                </p>
               </Link>
              ...
              <form>
                ...
                <p className="opacity-60 font-helvetica font-normal xs:pb-[13px] xs:text-[20px] xs:leading-[16px]">
                ...
                <fieldset className="form-control">
                  <div className="flex">
                    <input
                      ...
                      className="w-full h-[30px] input input-bordered xs:text-[20px] xs:leading-[20px] font-normal bg-emailColor font-helvetica rounded-none"
                    />
