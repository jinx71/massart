...
const PreviewShow_two = () => {
  ...
  return (
    <div>
          ...
          <div>
            ...
            <div className="md:text-[18px] md:leading-[30px] text-[12px] md:block">
              <p className="md:mb-9 mb-5 font-helvetica">
                The preview show, conceived by massArt, received overwhelming
                response in its inaugural year in 2022, being hailed at home and
                abroad as a breakthrough idea by creating a space to accommodate
                tourists who want to soak in the creative aspect of Durga Puja
                without jostling with the crowd.
              </p>
              <p className="md:mb-9 mb-5 font-helvetica">
                MassArt is back this year with its 3rd initiative, the preview
                show 2024 of Durga Puja Art. Over five days - from September 30
                to October 4 - the preview show will showcase a selection of the
                finest creations: 22 contemporary, 2 traditional, and 2
                aristocrat household Durga Pujas. Before pre-registered tourists
                from beyond the borders of the state and the country.
              </p>
              <p className="md:mb-9 mb-5 font-helvetica">
                Alongside the preview show at the puja sites, an exhibition on
                ‘Making of Durga Puja Art’ will take place during the period at
                the iconic town hall. The exhibition is a journey through the
                entire process, from conception to execution, using audio-visual
                footage and live demonstration. There is also an opportunity to
                sample the craftsmanship of artists and collect specimens of
                their art before stepping out to enjoy the creations on view at
                the chosen puja sites.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="2xl:ms-auto 2xl:me-auto max-w-7xl md:grid hidden  lg:grid-cols-2 grid-cols-1 xl:gap-[106px] lg:gap-[90px] gap-[30px] md:mb-[157px] mb-5 xl:ms-[125px] ms-[38px] xl:me-[125px] lg:ms-[100px] lg:me-[100px] me-[38px] mt-10">
        <div className="font-[Helvetica] md:hidden block text-[24px] leading-[30px] font-bold">
          Preview Show <span className="text-red-600">2025</span>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="md:text-[18px] md:leading-[30px] text-[12px] md:block hidden">
            <p className="md:mb-9 mb-5 font-helvetica">
              being a socially inclined organisation, massArt takes an endeavor
              of including in preview show of durga puja Art (psdpa) the faces
              of those who are not so privileged. thus we have multiple
              inclusive events for the orphans, old age people and differently
              abled children also we have mission eco-care programmes named-
              ecopaddle- a bicycle journey to durga puja Art venues without
              carbon footprint and greenitiative- a plantation drive in and
              around puja Art venues
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="2xl:ms-auto 2xl:me-auto max-w-7xl xl:ms-[125px] ms-[38px] xl:me-[125px] lg:ms-[100px] lg:me-[100px] me-[38px] md:mt-[150px] mt-[0] text-center font-[Helvetica] md:text-[50px] text-[24px] md:leading-[56px] leading-[30px] font-bold">
        <div className="md:mb-[40px] mb-[30px] text-md:center text-left">
          Inclusive <span className="text-buttonCustomColor">Events</span>
        </div>
        ...
        <div
          className="relative w-full mb-[60px] md:hidden block"
          {...handlers}
        >
      ...
      <div className="2xl:ms-auto 2xl:me-auto max-w-7xl xl:ms-[125px] ms-[38px] xl:me-[125px] lg:ms-[100px] lg:me-[100px] me-[38px] md:mt-[150px] mt-[60px] text-center font-[Helvetica] md:text-[50px] text-[24px] md:leading-[56px] leading-[30px] font-bold">
        <div className="md:mb-[40px] mb-[29px] text-md:center text-left">
          Mission <span className="text-buttonCustomColor">Eco-Care</span>
        </div>
