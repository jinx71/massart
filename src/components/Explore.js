const Explore = () => {
  return (
    <div
      className="  
         xs:pt-[40px] xs:pb-[25px] xs:px-[32px] lg:px-[0px] flex flex-col lg:flex-row"
    >
      ...
      <p className="xs:text-[12px] xs:leading-[24px] lg:text-[14px] text-justify font-helvetica font-normal w-full ">
